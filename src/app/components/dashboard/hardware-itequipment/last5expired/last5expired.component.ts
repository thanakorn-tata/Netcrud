...
@Component({
  selector: 'app-last5expired',
  imports: [TableModule, CommonModule, TranslateModule],
  templateUrl: './last5expired.component.html',
  styleUrl: './last5expired.component.scss'
})
export class Last5expiredComponent  implements OnInit {
