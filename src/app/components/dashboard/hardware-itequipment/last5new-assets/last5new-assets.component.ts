...
@Component({
  selector: 'app-last5new-assets',
  imports: [TableModule, CommonModule, TranslateModule],
  templateUrl: './last5new-assets.component.html',
  styleUrl: './last5new-assets.component.scss'
})
export class Last5newAssetsComponent  implements OnInit {
